...
namespace UnitTests.Engine.EngineBase
{
    ...
    public class RoundEngineBaseTests
    {
        ...
        [Test]
        public void testGetItemFromDroppedListIfBetterBase()
        {
            var result = Engine.Round.GetItemFromDroppedListIfBetter(null, ItemLocationEnum.Head);
            Assert.AreEqual(true, result);
        }
        #endregion GetItemFromDroppedListIfBetter

        [Test]
        public void testPickupDroppedItemsForAllCharacters()
        {
            var result = Engine.Round.PickupDroppedItemsForAllCharacters();
            Assert.AreEqual(true, result);
        }
        ...
        #region PickupItemsFromDroppedItems
        [Test]
        public void RoundEngine_PickupItemsFromDroppedItems()
        {
            // Act
            var result = Engine.Round.PickupItemsFromDroppedItems(null);

            // Assert
            Assert.AreEqual(true, result);
        }
        #endregion PickupItemsFromDroppedItems

        [Test]
        public void testSwapCharacterItemWithDroppedItem()
        {
            var result = Engine.Round.SwapCharacterItemWithDroppedItem(null, ItemLocationEnum.Feet, null);
